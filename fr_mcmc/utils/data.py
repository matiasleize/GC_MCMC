...
def read_data_DESI(file_DESI_1, file_DESI_2):
    ...
    covariance = rho * errors_dm_rd * errors_dh_rd
    Ccov = np.array([[errors_dm_rd**2, covariance],[covariance, errors_dm_rd**2]])
    Cinv=inv(Ccov)
    set_1 = z_eff_1, data_dm_rd, data_dh_rd, Cinv, wb_fid_1 
